...
(0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)(SortaApp).mount('#app');
/***********************************************/

/* Draggable Interaction
************************************************/

interactjs__WEBPACK_IMPORTED_MODULE_1___default()('.window').draggable({
  allowFrom: 'header',
  listeners: {
    move: dragMoveListener
  }
});
interactjs__WEBPACK_IMPORTED_MODULE_1___default()('.shortcut').draggable({
  listeners: {
    move: dragMoveListener
  }
});
