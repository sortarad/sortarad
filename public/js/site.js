...
SortaApp.component('DesktopWindow', _components_DesktopWindow_vue__WEBPACK_IMPORTED_MODULE_1__.default); // SortaApp.component('MenuBar', MenuBar)

SortaApp.use(vue3_click_away__WEBPACK_IMPORTED_MODULE_2__.default);
SortaApp.mount('#app');
/***********************************************/
...
interactjs__WEBPACK_IMPORTED_MODULE_3___default()('.window').draggable({
  allowFrom: 'header',
  listeners: {
    move: dragMoveListener
  }
});
interactjs__WEBPACK_IMPORTED_MODULE_3___default()('.shortcut').draggable({
  listeners: {
    move: dragMoveListener
  }
});
